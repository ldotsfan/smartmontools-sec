...
struct ata_print_options
{
  ...
  bool set_enhanced_erase; 
  bool set_security_erase; 
  bool set_security_freeze; // Freeze ATA security
  bool set_security_disable; // disable ATA security
  bool set_security_unlock;  // unlock ATA security locked device
  bool set_security_setpass; // set ATA security password 
